...
?>
	...
	<footer id="colophon" class="site-footer mt-6 py-6  flex justify-center" >
		...
		<div class="site-info">
			<div class="social-icons flex justify-center mb-3 ">
			...
			<?php if ( get_theme_mod( 'sleekly_footer_text' ) ) : ?>
				<p class="text-center text-gray-500 text-md"><?php echo get_theme_mod( 'sleekly_footer_text' ); ?></p>
			<?php else : ?>
				<?php
